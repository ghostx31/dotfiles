...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    after_files = { "/home/ghost/.local/share/lunarvim/site/pack/packer/opt/Comment.nvim/after/plugin/Comment.lua" },
  ...
  ["nvim-notify"] = {
    ...
    loaded = true,
    path = "/home/ghost/.local/share/lunarvim/site/pack/packer/start/nvim-notify",
